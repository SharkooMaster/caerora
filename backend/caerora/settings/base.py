...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        # CSRF-exempt: storefront POSTs are anonymous and Studio uses JWT, so
        # a logged-in Django admin session must not break public checkout.
...
# ---- Storefront cache invalidation (Studio -> Next.js ISR purge) ----
FRONTEND_INTERNAL_URL = env("FRONTEND_INTERNAL_URL", "http://frontend:3000")
